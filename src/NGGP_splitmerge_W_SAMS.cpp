...
void NGGPSplitMergeWSAMS::choose_indeces() {
  /**
...
int NGGPSplitMergeWSAMS::cluster_neighbors(int cluster) {
  /**
...
void NGGPSplitMergeWSAMS::sequential_allocation(int iterations, bool only_probabilities) {
  /**
...
double NGGPSplitMergeWSAMS::compute_acceptance_ratio_merge(double likelihood_old_ci,
...
void NGGPSplitMergeWSAMS::update_U() {
    /**
...
double NGGPSplitMergeWSAMS::log_conditional_density_V(double v) const {
    /**
...
void NGGPSplitMergeWSAMS::update_tau() {
    /**
...
double NGGPSplitMergeWSAMS::log_conditional_density_W(double w) const {
    /**
...
void NGGPSplitMergeWSAMS::merge_move() {
  /**
...
void NGGPSplitMergeWSAMS::split_move() {
  /**
...
double
NGGPSplitMergeWSAMS::compute_acceptance_ratio_split(double likelihood_old_cluster, 
