...
double SplitMerge::compute_acceptance_ratio_merge(double likelihood_old_ci, double likelihood_old_cj) {
    /**
...
double SplitMerge::compute_acceptance_ratio_shuffle(double likelihood_old_ci, double likelihood_old_cj, 
