...
void SplitMerge_SAMS::sequential_allocation(int iterations, bool only_probabilities){
    /**
...
double SplitMerge_SAMS::compute_acceptance_ratio_merge(double likelihood_old_ci, double likelihood_old_cj) {
    /**
...
void SplitMerge_SAMS::split_move() {
    ...
    */
    ...
    data.set_allocation(idx_j, data.get_K()); // Create a new cluster for point j if they are in the same cluster
...
double SplitMerge_SAMS::compute_acceptance_ratio_shuffle(double likelihood_old_ci, double likelihood_old_cj, 
