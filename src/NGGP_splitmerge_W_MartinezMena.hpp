...
class NGGPSplitMergeWMartinezMena : public Sampler {
  private:
  ...
  public:
    NGGPSplitMergeWMartinezMena(Data &d, Params &p, Likelihood &l, bool update_tau = false, double alpha = 0.1, double beta = 0.1)
