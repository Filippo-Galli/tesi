...
void NGGPSplitMergeWMartinezMena::choose_indeces() {
  /**
...
int NGGPSplitMergeWMartinezMena::cluster_neighbors(int cluster) {
  /**
...
void NGGPSplitMergeWMartinezMena::restricted_gibbs(int iterations, bool only_probabilities) {
  /**
...
double NGGPSplitMergeWMartinezMena::compute_acceptance_ratio_merge(double likelihood_old_ci,
...
void NGGPSplitMergeWMartinezMena::update_U() {
    /**
...
double NGGPSplitMergeWMartinezMena::log_conditional_density_V(double v) const {
    /**
...
void NGGPSplitMergeWMartinezMena::update_tau() {
    /**
...
double NGGPSplitMergeWMartinezMena::log_conditional_density_W(double w) const {
    /**
...
void NGGPSplitMergeWMartinezMena::merge_move() {
  /**
...
void NGGPSplitMergeWMartinezMena::split_move() {
  /**
  ...
  data.set_allocation(j, data.get_K()); // Create a new cluster for point j if
...
double NGGPSplitMergeWMartinezMena::compute_acceptance_ratio_split(double likelihood_old_cluster, 
...
void NGGPSplitMergeWMartinezMena::shuffle(){
  /**
...
double NGGPSplitMergeWMartinezMena::compute_acceptance_ratio_shuffle(double likelihood_old_ci, double likelihood_old_cj, 
...
void NGGPSplitMergeWMartinezMena::step() {
  /**
