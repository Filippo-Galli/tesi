...
void NGGPSplitMergeW::choose_indeces() {
  /**
...
int NGGPSplitMergeW::cluster_neighbors(int cluster) {
  /**
...
void NGGPSplitMergeW::restricted_gibbs(int iterations, bool only_probabilities) {
  /**
...
double NGGPSplitMergeW::compute_acceptance_ratio_merge(double likelihood_old_ci,
...
double NGGPSplitMergeW::log_conditional_density_V(double v) const {
    /**
...
void NGGPSplitMergeW::update_tau() {
    /**
...
double NGGPSplitMergeW::log_conditional_density_W(double w) const {
    /**
...
void NGGPSplitMergeW::merge_move() {
  /**
...
void NGGPSplitMergeW::split_move() {
  /**
...
double
NGGPSplitMergeW::compute_acceptance_ratio_split(double likelihood_old_cluster, 
