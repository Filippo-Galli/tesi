...
void DPSplitMergeW::choose_indeces() {
  /**
...
int DPSplitMergeW::cluster_neighbors(int cluster) {
  /**
...
void DPSplitMergeW::restricted_gibbs(int iterations, bool only_probabilities) {
  /**
...
double DPSplitMergeW::compute_acceptance_ratio_merge(double likelihood_old_ci,
